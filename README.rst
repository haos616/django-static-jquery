...
::
    ...
    $ pip install django-static-jquery==1.11.3
...
Static files::
    ...
    static_jquery/js/jquery.js - JQuery - v1.11.3
    static_jquery/js/jquery.min.js - JQuery (min) - v1.11.3
    static_jquery/js/jquery.min.map - JQuery (map) - v1.11.3
